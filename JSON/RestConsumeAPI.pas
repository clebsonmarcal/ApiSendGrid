...
type
 ...
 {Metodos Publicos da interface - Functios e Procedures da interface e declaradas na classe}
  function ExecutaMetodo(metodoRest : TTypeMetodo) : TRESTResponse overload;
  function ExecutaMetodo(metodoRest : TTypeMetodo ; Out StrRetorno : string; out StatusCode : integer) : TRESTResponse overload;
...
function TRestConsumeAPI.ExecutaMetodo(metodoRest : TTypeMetodo ; Out StrRetorno : string ; out StatusCode : integer) : TRESTResponse;
begin
  try
     case metodoRest of
       tpGet     : RESTRequest.Method := TRESTRequestMethod.rmGET;
     ...
     try
       ...
       strRetorno := RESTResponse.content;
...
{TODO -Aristoteles  -cRestConsumeAPi : function AddBodyJson - Adcionar um Body e recebe uma string no paramento}
